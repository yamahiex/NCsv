...
namespace CsvSerializerTests.Converters
{
    ...
    public class DateTimeConverterTests
    {
        ...
        public void ConvertToCsvItemTest()
        {
            ...
            Assert.AreEqual("01/01/2020 10:20:01", sut.ConvertToCsvItem(CreateConvertToCsvItemContext(new DateTime(2020, 1, 1, 10, 20, 1))));
            Assert.AreEqual("2020/01/01", sut.ConvertToCsvItem(CreateConvertToCsvItemContext(new DateTime(2020, 1, 1, 10, 20, 1), "FormattedValue")));
        }
        ...
        {
            var sut = new DateTimeConverter();
            Assert.IsTrue(sut.TryConvertToObjectItem(CreateConvertToObjectItemContext(csvItem, name), out object? result, out string _));
